...
int main() {
  ...
  personas.push_back(std::make_unique<Estudiante>("Juan", 30, "matricula"));
  personas.push_back(
      std::make_unique<Empleado>("Pedro", 25, "Seguro A", 50000));
  personas.push_back(std::make_unique<Estudiante>("Maria", 20, "123"));
